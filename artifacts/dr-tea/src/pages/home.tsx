  ...
  return (
    <div className="min-h-screen bg-[#FAF8F4] text-[#1a2416]">
      ...
      <nav aria-label="Shop tea by category" className="relative -mt-9 sm:-mt-12 z-20 px-4 sm:px-8 mb-6">
        <div className="max-w-5xl mx-auto bg-white rounded-2xl shadow-[0_8px_30px_-12px_rgba(26,36,22,0.18)] border border-gray-100/80 px-2 py-2">
      ...
      <section className="px-4 sm:px-8 mb-6">
        <div className="max-w-5xl mx-auto rounded-2xl overflow-hidden relative h-[180px] sm:h-[200px] bg-[#1a2416]">
